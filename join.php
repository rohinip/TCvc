		...
		<div class="inner t-center clearfix animated" data-animation="fadeIn" data-animation-delay="800">
			...
			<div class="col-xs-6 clearfix">
				...
				<div class="contact_form type-2 white-form">
					<!-- Form -->
					<form id="join_form" action="/webformmailer.php" method="post" name="cform" class="clearfix form oswald normal antialiased">
						<!-- 50% inputs -->
						<div class="fullwidth clearfix">
							...
							<div class="f-right">
								...
								<input type="text" name="citystate" id="citystate" required placeholder="City,State">
							</div>
						</div>
						<!-- End 50% inputs -->
						<!-- Subject -->
						...
						<input type="text" name="url" id="url" required placeholder="Product Url">
						...
						<div class="error_message">
							<p class="t-left no-margin">
								...
								Validation error occured. Please check your entries and submit again.
							</p>
						</div>
						<!-- Submit Message -->
			...
			<!-- End Contact Form -->
            <!-- Right Side -->
			<div class="col-xs-6 clearfix" style="padding:60px 0">
            	<img src="images/allhand.jpg" style="max-width:70%">
			</div>
            <!-- End Right Side -->
		</div>
		<!-- End Inner -->
